...
<script src="{$_G['style']['styleimgdir']}/js/jquery-1.11.2.min.js?{VERHASH}" type="text/javascript"></script>
<script type="text/javascript">jq = jQuery.noConflict();</script>
<script src="{$_G['style']['styleimgdir']}/js/nv.js?{VERHASH}" type="text/javascript"></script>
...
<!--{if !IS_ROBOT}--> 
<!--{if $_G['uid']}-->
<ul id="myprompt_menu1" class="p_pop" style="display: none !important;">
...
<div class="head" > 
  ...
  <div class="head-con">
    <p><!--{if !isset($_G['setting']['navlogos'][$mnid])}--><a href="{if $_G['setting']['domain']['app']['default']}http://{$_G['setting']['domain']['app']['default']}/{else}./{/if}" class="logo" title="$_G['setting']['bbname']">{$_G['style']['boardlogo']} </a><!--{else}-->$_G['setting']['navlogos'][$mnid]<!--{/if}--></p>
      <div id="dfnav" class="nav-mo clearfix" >
      <!--navs-->
