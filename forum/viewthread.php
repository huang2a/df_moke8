...
<style>
/*帖子内容页 分页 */
.df_vpgt,.df_vpgb,.pgbtn{ padding:0 10px;}

</style>
<div id="pgt" class="pgs df_vpgt ptm cl {if $modmenu['thread']}pbm bbs{/if}">
...
<!--{/if}-->
<!--{if $modmenu['thread']}-->
	<div id="modmenu" class="xi2 pbm ptm mr10 ml10">
		<!--{eval $modopt=0;}-->
		<!--{if $_G['forum']['ismoderator']}-->
...
<!--{/if}-->  
  ...
  <!--{if $modmenu['thread']}-->
  <div class="xi2 mbm pbm bbs  ptm mr10 ml10"> 
  ...
  <div class="pgs mtm mbm df_vpgb cl"> $multipage <span class="pgb y"{if $_G['setting']['visitedforums']} id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'21'})"{/if}><a href="$upnavlink">{lang return_forumdisplay}</a></span> </div>
...
<div class="ctr user_say">
  ...
  <div class="usershow cl" style="">
    <div class="cl tab ">
      <p>$df_lang[23]</p>
      <div style="height:0px;"></div>
      <div class="userinfo cl">
        <div class="userimg_left"> <a href="home.php?mod=space&uid=$_G[forum_thread][authorid]" title="$_G[forum_thread][author]" c="1" rel="nofollow"><!--{avatar($_G[forum_thread][authorid],small)}--></a> </div>
        <div class="userinfo_left">
          <ul class="xl xl2 o cl">
            <li> <a href="home.php?mod=space&uid=$_G[forum_thread][authorid]" title="$_G[forum_thread][author]" rel="nofollow">$_G[forum_thread][author]</a> </li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div>
    ...
    <div class="bm_c2 listm list31 rank">
      <ul>
        <!--[diy=diytopdown]-->
        <div id="diytopdown" class="area"></div>
        <!--[/diy]-->
  ...
  <div>
    ...
    <div class="bm_c2 fenlei"> 
      <!--{eval $df_tags = C::t(common_tag)->fetch_all_by_status();}--> 
      <!--{eval $num = 1;}--> 
      
      <!--{loop $df_tags $df_tag}--> 
      <!--{if $num<=15 }--> 
      
      <a href="misc.php?mod=tag&id=$df_tag[tagid]" target="_blank">$df_tag[tagname]</a> 
